...
*/
			...
			this.jobdomain = function(id) {
				if(id!=undefined){
					return this.request({API: AppConfig.API_ENDPOINTS.settings.userManagement.jobdomains,data:{jobDomainId:id}});
				}
				else{
					return this.request({API: AppConfig.API_ENDPOINTS.settings.userManagement.jobdomains});
				}
			}

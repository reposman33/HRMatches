NG_DOCS={
  ...
  "pages": [
    ...
    {
      "section": "api",
      "id": "app.ontdekJouwTalent.controller:RegisterController",
    ...
    {
      "section": "api",
      "id": "app.ontdekJouwTalent.controller:SettingsController",
    ...
    {
      "section": "api",
      "id": "app.ontdekJouwTalent.controller:TranslationController",
      "shortName": "TranslationController",
      "type": "controller",
      "moduleName": "app.ontdekJouwTalent",
      "shortDescription": "This controller contains functionality for language strings and editing translations.",
      "keywords": "$scope $state api app authservice controller data dependencies edit editing edittranslation functionality key language method newpage ontdekjouwtalent paginate parameter referring retrieve returns save sessionservice strings submits subset translation translationkey translations translationservice translationvalue updated"
    },
    {
      "section": "api",
      "id": "app.ontdekJouwTalent.controller:UserManagementController",
    ...
    {
      "section": "api",
      "id": "app.ontdekJouwTalent.service:APIService",
